...
keymap.set("n", "<leader>nf", ":NvimTreeFocus<CR>") -- toggle focus to file explorer
...
keymap.set('n', '<C-g>', require('telescope.builtin').live_grep, {}) -- grep file contents in project
